    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (manager != null && channel != null) {
                    ...
                    if (wifi.setWifiEnabled(false)){
                        ...
                        wifiEnable.setText("Disable WiFi");
                    }
                    else {
                        wifi.setWifiEnabled(true);
                        wifiEnable.setText("Enable WiFi");
                    }
        ...
        wifiDiscover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                manager.createGroup(channel, config, new ActionListener() {
                    @Override
                    public void onSuccess() {
                        manager.requestGroupInfo(channel, new WifiP2pManager.GroupInfoListener() {
                            @Override
                            public void onGroupInfoAvailable(WifiP2pGroup group) {
                                String groupName = WifiP2pGroup.getNetworkName();
                                Toast.makeText(WiFiDirectActivity.this, "Group Made",
                    ...
                    public void onFailure(int reason) {
                        Toast.makeText(WiFiDirectActivity.this, "Couldn't make Group",
